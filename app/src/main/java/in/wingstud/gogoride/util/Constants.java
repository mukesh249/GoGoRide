package in.wingstud.gogoride.util;
...
public class Constants {
    ...
    public static String FLD_ROLE = "role";
    public static String FLD_IS_VARIFIED = "isVarified";
    public static String FLD_DEVICEID = "deviceId";
    ...
    public static String FLD_ACTIVE_MODE = "activeMode";
    ...
    public static String FLD_RATING_DRIVER_TO_USER = "ratingDriverToUser";
    public static String RENTAL_CAR = "rentalCar";
    public static String LOCAL_RIDE = "localRide";
    public static String LOGISTIC = "logistic";
    public static String FOR_WHICH = "forWhich";
    public static String IS_RENTAL_CAR = "isRentalCAr";
}
