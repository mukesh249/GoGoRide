...
public class Constrants {
    ...
    public static final String DeliveryLong = "deliveryLong";
    ...
    public static String IsGoogleLogin  = "isGoogleLogin";
    public static String IsFBLogin  = "isFBLogin";
    ...
    public static String CancelReturn = "cancelReturn";
    public static String Faq = "Faq";
    public static String City = "city";
    public static String State = "state";
    public static String PickAddress = "pickAddress";
    public static String PickUpLat = "pickUpLat";
    public static String PickUpLong = "pickUpLong";

    public static String DropAddress = "dropAddress";
    public static String DropLat = "dropLat";
    public static String DropLong = "dropLong";
}
