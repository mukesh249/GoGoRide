...
public class SharedPrefManager {
    ...
    public static void setUserImageLink(String type, String userId) {
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(type, userId);
        editor.apply();
    }

    public static String getUserImageLink(String type) {
        return sp.getString(type, "");
    }
    ...
    public static void setPickUpAddress(String type, String userId) {
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(type, userId);
        editor.apply();
    }

    public static String getPickUpAddress(String type) {
        return sp.getString(type, "");
    }
    public static void setPickUpLat(String type, String userId) {
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(type, userId);
        editor.apply();
    }
    public static String getPickUpLat(String type) {
        return sp.getString(type, "");
    }
    public static void setPickUpLong(String type, String userId) {
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(type, userId);
        editor.apply();
    }
    public static String getPickUpLong(String type) {
        return sp.getString(type, "");
    }


    public static void setDropAddress(String type, String userId) {
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(type, userId);
        editor.apply();
    }
    public static String getDropAddress(String type) {
        return sp.getString(type, "");
    }
    public static void setDropLat(String type, String userId) {
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(type, userId);
        editor.apply();
    }
    public static String getDropLat(String type) {
        return sp.getString(type, "");
    }
    public static void setDropLong(String type, String userId) {
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(type, userId);
        editor.apply();
    }
    public static String getDropLong(String type) {
        return sp.getString(type, "");
    }
